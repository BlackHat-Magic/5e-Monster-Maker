...
<section class="editor-section" aria-labelledby="basics-heading">
	<div class="editor-section__intro">
		<p class="section-label">03 / Context</p>
	...
	<div class="editor-grid editor-grid--two">
		<Field id="monster-size" label="Size">
		...
		<Field id="monster-type" label="Type">
			{#snippet children(control)}
		...
		<Field id="monster-tag" label="Tag" description="Optional subtype, such as shapechanger or goblinoid.">
			{#snippet children(control)}
		...
		<Field id="monster-alignment" label="Alignment">
			{#snippet children(control)}
	...
	<Field id="monster-flavor" label="Flavor text" description="A compact opening description for the generated stat block.">
		{#snippet children(control)}
